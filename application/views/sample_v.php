 ...
 ?>
    ...
    <div class="panel panel-success">
      <div class="panel-heading">
        <h3 class="panel-title">Add Lab Smaple Handling <?php echo $acronym; ?> <span class="glyphicon glyphicon-plus" style=""></span></h3>
      </div>
      <div class="panel-body" style="overflow-y: auto">
        <div style="/*border: 1px solid #036;*/ ;" id="container">
        
        <form class="form-horizontal" method="post" action="<?php echo base_url().'c_disease/edit_lab' ?>" role="form">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <textarea name="defition" placeholder='' required rows="7" class="form-control"><?php echo $sample;  ?></textarea>
    </div>
  </div>
