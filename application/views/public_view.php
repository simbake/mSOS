...
<fieldset>
	...
	<?php if($disease >0):?>   
		<div class="message warning">
			...
			<p>
			<a class="linkss">
			<?php echo $disease; ?> Disease(s)</a> have been reported.
			</p>
		</div>
		<?php endif; ?>
		<?php if($incident >0):?>
 ...
 <?php echo renderChart("" . base_url() . "Scripts/FusionCharts/StackedColumn2D.swf", "", $strXML_e5, "e_6", 630, 400, false, true); ?>
</fieldset>
