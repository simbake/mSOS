              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    <img src="<?php echo base_url() ?>assets/img/user2-160x160.jpg" class="img-circle" alt="User Image" />
                    <p>
                      <?php echo $this->session->userdata("full_name")." - ".$this->session->userdata("user_indicator") ?>
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="<?php echo base_url().'user_management/logout' ?>" class="btn btn-default btn-flat">Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
          ...
          <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="small-box bg-green">
                <div class="inner">
                  <h3><?php echo $reported_cases ?><sup style="font-size: 20px"></sup></h3>
                  <p>Reported Cases</p>
                </div>
                <div class="icon">
                ...
                <div class="box-body">
                  ...
                  <div class="direct-chat-contacts">
                    <ul class='contacts-list'>
                      <li>
                        <a href='#'>
                          <img class='contacts-list-img' src='<?php echo base_url() ?>assets/img/user1-128x128.jpg'/>
                      ...
                      <li>
                        <a href='#'>
                          <img class='contacts-list-img' src='<?php echo base_url() ?>assets/img/user7-128x128.jpg'/>
                          <div class='contacts-list-info'>
                            <span class='contacts-list-name'>
                              Sarah Doe
                      ...
                      <li>
                        <a href='#'>
                          <img class='contacts-list-img' src='<?php echo base_url() ?>assets/img/user3-128x128.jpg'/>
                          <div class='contacts-list-info'>
                            <span class='contacts-list-name'>
                              Nadia Jolie
                      ...
                      <li>
                        <a href='#'>
                          <img class='contacts-list-img' src='<?php echo base_url() ?>assets/img/user5-128x128.jpg'/>
                          <div class='contacts-list-info'>
                            <span class='contacts-list-name'>
                              Nora S. Vans
                      ...
                      <li>
                        <a href='#'>
                          <img class='contacts-list-img' src='<?php echo base_url() ?>assets/img/user6-128x128.jpg'/>
                          <div class='contacts-list-info'>
                            <span class='contacts-list-name'>
                              John K.
                      ...
                      <li>
                        <a href='#'>
                          <img class='contacts-list-img' src='<?php echo base_url() ?>assets/img/user8-128x128.jpg'/>
                          <div class='contacts-list-info'>
                            <span class='contacts-list-name'>
                              Kenneth M.
              ...
              <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                  <ul class="users-list clearfix">
                    ...
                    <li>
                      <img src="<?php echo base_url() ?>assets/img/user5-128x128.jpg" alt="User Image"/>
