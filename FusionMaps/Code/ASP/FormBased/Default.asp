...
<BODY>
	...
	'The form is rendered in this page (Default.asp). 
	'It submits its data to FormSubmit.asp. 
	'In FormSubmit.asp, we retrieve this data, convert into XML and then
	'render the map.
	
	'So, basically this page is just a form. 
	%>
	<CENTER>
	<h2><a href="http://www.fusioncharts.com" target="_blank">FusionMaps</a> - ASP Samples
    </h2>
	...
	<FORM NAME='SalesForm' ACTION='FormSubmit.asp' METHOD='POST'>
	<table width='50%' align='center' cellpadding='2' cellspacing='1' border='0' class='text'>
		...
		<tr>
		  <td align='right'>&nbsp;</td>
		  <td><input name="submit" type='submit' value='MAP it!'></td>
	  </tr>
	</table>
	</FORM>
	<BR>
