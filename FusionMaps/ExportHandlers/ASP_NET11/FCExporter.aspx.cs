/**
 * [ Built for ASP.NET 1.1 ]
 * FusionCharts/FusionMaps Exporter is an ASP.NET 1.1 C# script that handles 
 * FusionCharts/FusionMaps (since v3.1) Server Side Export feature.
 * This in conjuncture with various export classes would 
 * process FusionCharts/FusionMaps Export Data POSTED to it from FusionCharts/FusionMaps 
 ...
 *
 * This script might be called as the FusionCharts/FusionMaps Exporter - main module 
 *
 *    @author FusionCharts
 *    @description FusionCharts Exporter (Server-Side - ASP.NET 1.1 C#)
 *    @version 2.0 [ 19 March 2009 ]
 *  
 */
/**
 ...
 *
 *   1.0 [ 20 March 2009 ]
 *       - Integrated with new Export feature of FusionCharts/FusionMaps 3.1
 *       - can save to server side directory
 *       - can provide download or open in popup window.
 *       - can report back to chart/map
 ...
 *  -------------
 *
 *  chart/map would POST export data (which consists of encoded image data stream,  
 ...
 *  ISSUES
 *  ------
 *   Q. What if someone wishes to open in the same page where the chart/map existed as postback
 *      replacing the old page?
 * 
 *   A. Not directly supported using any chart/map attribute or parameter but can do by
 *      removing/commenting the line containing 'header( content-disposition ...'
 *     
 */
/**
 * 
 *   @requires	FCIMGGenerator  Class to export FusionCharts/FusionMaps image data to JPG, PNG, GIF binary
 *   @requires  FCPDFGenerator  Class to export FusionCharts/FusionMaps image data to PDF binary
 *
 */
...
/// <summary>
/// FusionCharts/FusionMaps Exporter is an ASP.NET C# script that handles 
/// FusionCharts/FusionMaps (since v3.1) Server Side Export feature.
/// This in conjuncture with other resource classes would 
/// process FusionCharts/FusionMaps Export Data POSTED to it from FusionCharts/FusionMaps 
...
/// </summary>
/// 
public class FCExporter : System.Web.UI.Page
{
    /// <summary>
    /// IMPORTANT: You need to change the location of folder where 
    /// the exported chart/map images/PDFs will be saved on your 
    ...
    /// the folder where exported charts/maps will be saved. 
    ...
    /// <summary>
    /// Lists the default exportParameter values taken, if not provided by chart/map
    /// </summary>
    ...
    /// <summary>
    /// Stores server notices, if any as string [ to be sent back to chart/map after save ] 
    /// </summary>
    private string notices = "";
    /// <summary>
    /// Whether the export action is download. Default value. Would change as per setting retrieved from chart/map.
    /// </summary>
    private bool isDownload = true;

    /// <summary>
    /// DOMId of the chart/map
    /// </summary>
    ...
    /// </summary>
    /// <param name="sender">FusionCharts/FusionMaps chart/map SWF</param>
    /// <param name="e"></param>
    protected void Page_Load(object sender, EventArgs e)
    {
        /**
         * Retrieve export data from POST Request sent by chart/map
        ...
        exportObject.Close();
        /*
         * Build Appropriate Export Status and send back to chart/map by flushing the  
         * procesed status to http response. This returns status back to chart/map. 
    ...
    /// <summary>
    /// Parses POST stream from chart/map and builds a Hashtable containing 
    ...
    /// and 'parameters' ( Hashtable of all export parameters from chart/map as keys, like - exportFormat, 
    ...
    private Hashtable parseExportRequestStream()
    {
        ...
        //get width and height of the chart/map
    ...
    /// <param name="stream">(string) Export image data in FusionCharts/FusionMaps compressed format</param>
    ...
    /// <summary>
    /// Flushes exported status message/or any status message to the chart/map or the output stream.
    ...
    /// <param name="meta">Hastable containing meta descriptions of the chart/map like width, height</param>
    ...
    /// a & to build a querystring (to pass to chart/map) or joined by a HTML <BR> to show neat
...
/// <summary>
/// FusionCharts/FusionMaps Image Generator Class
/// FusionCharts/FusionMaps Exporter - 'Image Resource' handles 
/// FusionCharts/FusionMaps (since v3.1) Server Side Export feature that
/// helps FusionCharts/FusionMaps exported as Image files in various formats. 
/// </summary>
public class FCIMGGenerator
{
    //Array - Stores multiple chart/map export data
	...
	/// <summary>
	/// Generates bitmap data for the image from a FusionCharts/FusionMaps export format
...
/// <summary>
/// FusionCharts/FusionMaps Exporter - 'PDF Resource' handles 
/// FusionCharts/FusionMaps (since v3.1) Server Side Export feature that
/// helps FusionCharts/FusionMaps exported as PDF file.
/// </summary>
public class FCPDFGenerator
{
	...
	/// The imageData_FCFormat parameter is the FusionCharts/FusionMaps export format data
    ...
    //create image PDF object containing the chart/map image 
...
/// 
/// The chart/map image compression ratio comes to around 10:3 
/// 
/// </summary>
