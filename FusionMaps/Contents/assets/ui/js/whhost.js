...
{
	return "<div id=\""+gsLoadingDivID+"\" style=\"position:absolute;top:0;left:5px;z-index:600;visibility:hidden;padding:4px; margin:5px;background-color:#E9E9E9;border:1px solid #DFDFDF;width:90%;font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; color:#555258;\">"+gsLoadingMsg+"</div>";
}
