...
var gsHiliteSearchSetting = "enable,#b2b4bf,#000000";
var gsQuote='\x22'; 
var gsBkgndColor="";
var gsTextColor="";
var BTN_TEXT=1;
...
function DomTextNode( a_Node, a_nFrom )
{
	...
	{
		s_strHlStart = "<font style='color:" + "#000" + "; background-color:" + "#EFFF79" + "'>";
		s_strHlEnd = "</font>";
...
function addButton(sType,nStyle,sText,sHref,sOnClick,sOnMouseOver,sOnLoad,nWidth,nHeight,sImg1,sImg2,sImg3)
{
	...
	{
		if(isShowHideEnable()|| true)
		{
			var sTitle="Show Navigation Component";
			goShowNav=new button(sText,nWidth,nHeight,sImg1,sImg2,sImg3);
			sButton="<a id=\"showNavButtonId\" title=\""+sTitle+"\" class=\"whtbtnshownav\" href=\"javascript:void(0);\" onclick=\"showHidePane(true); toggleShowHideButton(this,'hideNavButtonId');return false;\">";
			if(nStyle==BTN_TEXT)
	...
	else if(sType=="hidenav")
	{
		if(isShowHideEnable() || true)
		{
			...
			sButton="<a id=\"hideNavButtonId\" title=\""+sTitle+"\" class=\"whtbtnhidenav\" href=\"javascript:void(0);\" onclick=\"showHidePane(false);  toggleShowHideButton(this,'showNavButtonId');;return false;\">";
			if(nStyle==BTN_TEXT)
...
//// added 24 June 2011////
function toggleShowHideButton(hideElm, showElmId)
{	
	hideElm.parentNode.style.display = "none";
	document.getElementById(showElmId).parentNode.style.display = "inline";
}
...
function show()
{
	...
	if(gbBadUriError)
	{
		...
		if(indx != -1)
			window.location = strMainPage.substring(0, indx+1) + "/index.html?" + strMainPage.substring(indx+1);
		else if(gsStartPage!="")
...
if(window.gbWhUtil && window.gbWhVer && (gbAIRSSL ||(window.gbWhMsg&&window.gbWhProxy)))
{
	if(!gbAIRSSL)
	{
		RegisterListener("FMXTcontentFrame",WH_MSG_GETAVIAVENUES);
		RegisterListener("FMXTcontentFrame",WH_MSG_GETTOCPATHS);
		RegisterListener("FMXTcontentFrame",WH_MSG_NEXT);
		RegisterListener("FMXTcontentFrame",WH_MSG_PREV);
		RegisterListener("FMXTcontentFrame",WH_MSG_WEBSEARCH);
	}
	if(gbMac&&gbIE4)
	{
