//	WebHelp 5.10.002
var gsDefaultTarget="FMXTcontentFrame";
...
function writeOneItem(oHTML,bDown,aDataCon,aCurIdxSet,nLength,aPos,nLevel)
{
	...
	if(nLevel==1){
		if(getItemType(aDataCon,nIdxSet,nIIdx)==1)
		{
			...
			sHTML+="<p style=\"margin-left:"+gsIdxIndent+";padding-top:5px;\"><nobr>";
			...
			if(sTopics.length>0)
			{
				...
				sHTML+=sTopics+");return false;\" style=\"font-weight:bold; \">"+sKName+"</a></nobr></p>";
			}
			else
			{
				sHTML+="<span title=\"" + sKName + "\" onfocus=\"clearHighLight();\" style=\""+getFontStyle(goIdxEmptyFont)+";font-weight:bold;\">"+sKName+"</span></nobr></p>";
			}
		}
	}
	else if(nLevel>=2){
		...
		{
			sHTML+="<span title=\"" + sKName + "\"  onfocus=\"clearHighLight();\" style=\""+getFontStyle(goIdxEmptyFont)+";font-weight:bold;\">"+sKName+"</span></nobr></h6>";
		}
...
function IndexWriteClassStyle()
{
	...
	{*/
		//sStyle+="H6.firstsub a { font-weight:bold; }\n";
		sStyle+="P {"+getFontStyle(goIdxFont)+"margin-top:"+gsIdxMargin+";margin-bottom:"+gsIdxMargin+";}\n";
		sStyle+="P {"+getFontStyle(goIdxFont)+"margin-top:"+gsIdxMargin+";margin-bottom:"+gsIdxMargin+";}\n";
		sStyle+="H6 {"+getFontStyle(goIdxFont)+"margin-top:"+gsIdxMargin+";margin-bottom:"+gsIdxMargin+";}\n";
	//}
	...
	sStyle+="A:active {"+getFontStyle(goIdxHoverFont)+"}\n";
	sStyle+="A:hover {"+getFontStyle(goIdxHoverFont)+"}\n";
	sStyle+="A:focus {"+getFontStyle(goIdxHoverFont)+"}\n";
	sStyle+="</STYLE>";	
