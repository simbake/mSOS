...
function writeFormStyle()
{
	...
	sStyle += "input { border:1px solid #ccc; }\n";
	sStyle += "p.title {" + getFontStyle(goTitleFont) + "margin-top:0;margin-bottom:0}\n";
	sStyle += ".inputfield {" + getFontStyle(goInputFont) +"width:163px;  border:0; background-color:#FBFBFB; }\n";
	...
	if (gsBgImage)
		...
		//sStyle+="border-top:white 1px solid;}\n";
...
function getFormHTML()
{
	...
	sForm += "<td>";
	if(gbSafari3)
	    sForm += "<p class=title style='line-height:20px;'> &nbsp;&nbsp;" + gsTitle + "<br><table width=\"100%\"><tr valign=\"middle\"><td  height=\"23\" width=\"100%\" valign=\"top\" style=\"background-image:url('../../../Images/text_field.jpg'); background-repeat:no-repeat; padding:4px;padding-left:10px; \"><input class=\"inputfield\" type=\"text\" name=\"keywordField\" onfocus=\"inputEnable(1);\"\"></td>";
	else
	    sForm += "<p class=title  style='line-height:20px;'> &nbsp;&nbsp;" + gsTitle + "<br><table width=\"100%\"><tr valign=\"middle\"><td  height=\"23\" width=\"100%\" valign=\"top\" style=\"background-image:url('../../../Images/text_field.jpg'); background-repeat:no-repeat;  padding:4px;padding-left:10px;\"><input class=\"inputfield\" type=\"text\" name=\"keywordField\" onKeyPress=\"lookupKeyDown();\" onfocus=\"inputEnable(1);\" onblur=\"inputEnable(0);\"></td>";
	if (gbWithButton && gnType >= 0)
	{
		sForm += "<td valign=\"top\" height=\"23\"><a title=\"Click to search\" href=\"javascript:void(0);\" onclick=\"" + gstrFormName + ".submit(); return false;\" onfocus=\"inImage(1);\" onblur=\"inImage(0);\" onmouseup=\"onMouseUp();\" onmousedown=\"onMouseDown();\" onmouseover=\"onMouseOver();\" onmouseout=\"onMouseOut();\">"
		if (gnType == 0)
		{
			if (!gsText)
				gsText="Go";
			sForm += "<img alt=\""+gsText+"\" id=\"go\" border=\"0\" src=\"" + gsOutImage + "\" align=\"top\" >";
		}
		else
			sForm += gsText ;
		sForm += "</a></td>";
	...
	sForm += "</table></p></td></tr></form>";
	if(oMsg.oParam == "fts")
		sForm += "<tr><td height='15'><div  style='height:15px; border-top:1px solid #dfdfdf; font-size:10px; line-height:15px; padding-left:10px;' >&nbsp;</div></td></tr>";
	sForm += "</table>";
